...
<div class="shell">
  <section class="hero">
    <div class="hero-main">
      ...
      <h1>KeyCenter Approvals</h1>
      <p class="hero-copy">
        This page is the canonical entry for approval-oriented flows that KeyCenter serves directly.
    ...
    <aside class="hero-side">
      <h2>Current scope</h2>
      <ul>
        <li>Rebind approval runs against KeyCenter APIs directly.</li>
        <li>Secure secret input now lands on KeyCenter-owned token pages.</li>
        <li>Install custody remains KeyCenter-native at <span class="mono">/ui/install/custody</span>.</li>
        <li>Legacy approval proxy routes are removed from KeyCenter.</li>
      </ul>
    </aside>
  </section>
    ...
    <section class="panel" id="rebind">
      <div class="panel-head">
        <div>
          ...
          <div class="panel-sub">Load a rebind plan by runtime hash or label, then approve it from KeyCenter.</div>
        </div>
    ...
    <section class="panel" id="custody">
      <div class="panel-head">
        <div>
          ...
          <div class="panel-sub">Create a KeyCenter-native custody challenge and copy the generated approval link.</div>
        </div>
    ...
    <section class="panel">
      <div class="panel-head">
        <div>
          ...
          <div class="panel-sub">Current KeyCenter approval surface without legacy proxy fallback.</div>
        </div>
      </div>
      <div class="stack">
        <div class="event">
