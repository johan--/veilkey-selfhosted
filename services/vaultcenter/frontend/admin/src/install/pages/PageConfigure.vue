  ...
  <div class="configure-page">
    ...
    <div class="derived-preview">
      ...
      <dl>
        ...
        <dt>{{ t.derivedVaultcenterUrl }}</dt>
        <dd>{{ derivedVaultcenterUrl }}</dd>
...
const i18n = {
  ko: {
    ...
    derivedVaultcenterUrl: 'VaultCenter URL',
...
const derivedVaultcenterUrl = computed(() => {
...
async function goNext() {
  ...
  store.config.vaultcenter_url = derivedVaultcenterUrl.value
