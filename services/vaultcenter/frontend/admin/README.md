# VaultCenter Admin UI

This directory is the first cut of the dedicated Vue 3 frontend workspace for the VaultCenter admin UI.
...
- VaultCenter no longer falls back to the legacy `admin_vue_preview.html`
