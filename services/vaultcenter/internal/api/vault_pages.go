    ...
    <section class="panel" id="actions">
      ...
      <div class="grid-2">
        <div class="panel" style="padding:16px;background:#0c1822">
          ...
          <p class="muted" style="margin:0 0 12px">This schedules the existing VaultCenter planned rotation pass. Current API is global, so use with operator judgment.</p>
