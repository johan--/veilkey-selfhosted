...
# VeilKey VaultCenter Installer — Linux
#
# Usage:
#   curl -sf http://your-gitlab/veilkey/veilkey-vaultcenter/-/raw/main/install/server-linux.sh | bash
#
# Environment:
...
echo "=== VeilKey VaultCenter Install (Linux) ==="
echo ""
